...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CC_mi2s.Version'
        db.add_column('CC_mi2s', 'Version',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=20),
                      keep_default=False)

        # Adding field 'CC_mi3w.Version'
        db.add_column('CC_mi3w', 'Version',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=20),
                      keep_default=False)

        # Adding field 'CC_mi3td.Version'
        db.add_column('CC_mi3td', 'Version',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=20),
                      keep_default=False)

        # Adding field 'CC_mi2a.Version'
        db.add_column('CC_mi2a', 'Version',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CC_mi2s.Version'
        db.delete_column('CC_mi2s', 'Version')

        # Deleting field 'CC_mi3w.Version'
        db.delete_column('CC_mi3w', 'Version')

        # Deleting field 'CC_mi3td.Version'
        db.delete_column('CC_mi3td', 'Version')

        # Deleting field 'CC_mi2a.Version'
        db.delete_column('CC_mi2a', 'Version')
